...
class EventTest {
    ...
    fun `should return if an event has a valid Id`(eventFixture: String) {
        ...
        assertFalse(event.copy(id = "invalid").hasValidId())
    ...
    fun `should return if an event has a valid signature`(eventFixture: String) {
        ...
        assertFalse(event.copy(pubkey = "invalid").hasValidSignature())
        assertFalse(event.copy(sig = "invalid").hasValidSignature())
